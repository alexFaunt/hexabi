...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HexGridHexGrid = __webpack_require__(159);
...
/***/ function(module, exports) {
	...
	module.exports = {"base":"App__base___3WpmO"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HexGridCss = __webpack_require__(160);

	var _HexGridCss2 = _interopRequireDefault(_HexGridCss);

	var _react = __webpack_require__(1);

	var _react2 = _interopRequireDefault(_react);

	var _HexRowHexRow = __webpack_require__(161);

	var _HexRowHexRow2 = _interopRequireDefault(_HexRowHexRow);
	...
	var HexGrid = (function (_Component) {
	    ...
	    function HexGrid() {
	        ...
	        _get(Object.getPrototypeOf(HexGrid.prototype), 'constructor', this).apply(this, arguments);
	    }
	    ...
	    _createClass(HexGrid, [{
	        ...
	        value: function render() {
	            ...
	            var colCount = parseInt(this.props.cols, 10);

	            var hexesPerRow = !!(colCount % 2) ? (colCount + 1) / 2 : colCount / 2;

	            // One of these has to be populated
	            // const hexCount = parseInt(this.props.hexes, 10);
	            var rowCount = parseInt(this.props.rows, 10);
	            ...
	            for (var i = 0; i < rowCount; i += 1) {
	                ...
	                var hexRow = _react2['default'].createElement(_HexRowHexRow2['default'], null);
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"base":"HexGrid__base___CBiHK"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HexRowCss = __webpack_require__(162);

	var _HexRowCss2 = _interopRequireDefault(_HexRowCss);

	var _react = __webpack_require__(1);

	var _react2 = _interopRequireDefault(_react);

	var _HexHex = __webpack_require__(163);

	var _HexHex2 = _interopRequireDefault(_HexHex);

	// import hexMath from '../shared/hexMath/hexMath'; // TODO - why doesnt this work.

	var HexRow = (function (_Component) {
	    _inherits(HexRow, _Component);

	    function HexRow() {
	        _classCallCheck(this, HexRow);

	        _get(Object.getPrototypeOf(HexRow.prototype), 'constructor', this).apply(this, arguments);
	    }
	    ...
	    _createClass(HexRow, [{
	        ...
	        value: function render() {
	            ...
	            var maxHexes = parseInt(this.props.maxHexes, 10);

	            // 4x + 3x/2
	            // 11x/2 = 100%
	            // x = (100 * 2) / 11
	            // x = 200 / ((i*2 + (i-1))
	            var hexWidth = 200 / (maxHexes * 2 + (maxHexes - 1));

	            // mark up array to be wrapped
	            var markup = [];

	            var hexCount = this.props.even ? maxHexes - 1 : maxHexes;

	            for (var i = 0; i < hexCount; i += 1) {
	                // Lots of hexes in a row
	                var hex = _react2['default'].createElement(_HexHex2['default'], null);
	            ...
	            var className = _HexRowCss2['default'].base;

	            var style = {};

	            if (this.props.even) {
	                className += ' ' + _HexRowCss2['default'].even;
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"base":"HexRow__base___VvHKj","even":"HexRow__even___3pknX"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HexCss = __webpack_require__(164);

	var _HexCss2 = _interopRequireDefault(_HexCss);
	...
	var Hex = (function (_Component) {
	    ...
	    function Hex() {
	        ...
	        _get(Object.getPrototypeOf(Hex.prototype), 'constructor', this).apply(this, arguments);
	    }
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"base":"Hex__base___30Sah"};
